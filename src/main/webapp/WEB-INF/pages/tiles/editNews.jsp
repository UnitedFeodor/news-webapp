    ...
    <form>
        <table class="news_text_format">
            ...
            <tr>
                ...
                <td class="space_around_view_text"><div class="word-breaker">
                    <textarea rows="7" cols="30" name="news_brief" style="resize: none;"><c:out value="${requestScope.news.briefNews }" />
                    </textarea>
            ...
            <tr>
                ...
                <td class="space_around_view_text"><div class="word-breaker">
                    <textarea rows="11" cols="30" name="news_content" style="resize: none;"><c:out value="${requestScope.news.content }" />
                                        </textarea>
